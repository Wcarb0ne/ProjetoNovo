        ...
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand navbar-brand-logo" href="#">
                    ...
                    <div class="brand">NexTech</div>
                </a>
            </div>
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    <li>
                        <a href="javascript:void(0)" data-href="#" class="scroll-down">
                            Voltar
                        </a>
                    </li>
                    <li>
                ...
                <div class="card-container">
                    <div class="card">
                        <div class="front">
                            ...
                            <div class="user">
                                <img class="img-circle" src="images/felipe.png" />
                            </div>
                            <div class="content">
                                <div class="main">
                ...
                <div class="card-container">
                    <div class="card">
                        <div class="front">
                            ...
                            <div class="user">
                                <img class="img-circle" src="images/Thiago.jpg" />
                            </div>
                            <div class="content">
                                <div class="main">
                ...
                <div class="card-container">
                    <div class="card">
                        <div class="front">
                            ...
                            <div class="user">
                                <img class="img-circle" src="images/Kauã.jpg" />
                            </div>
                            <div class="content">
                                <div class="main">
                ...
                <div class="card-container">
                    <div class="card">
                        <div class="front">
                            ...
                            <div class="user">
                                <img class="img-circle" src="images/wellington.jpeg" />
                            </div>
                            <div class="content">
                                <div class="main">

...
<form id="my-form" action="#" class="from-control" method="post" onsubmit="return false">
    ...
    <div class="row">
        <div class="col-sm-3">
            ...
            <input type="text" class="form-control" name="txtID" id="txtID" placeholder="ID Serviços" disabled>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-3">
            <label for="Nome">Contato do Cliente</label>
        ...
        <div class="col-sm-3">
            ...
            <input type="number" class="form-control" name="txtEmailCliente" id="txtEmailCliente" placeholder="Insira o E-mail do Cliente">
        </div>
    </div>
    <p></p>
    <div class="row">

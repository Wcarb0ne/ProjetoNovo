...
if($_POST)
{
    ...
    try {
        $sql = $conn->prepare(
            ...
            (status_Parceiro,nome_Parceiro,cnpj_Parceiro,ramo_Parceiro,email_Parceiro,telefone1_Parceiro,telefone2_Parceiro,login_Parceiro,senha_Parceiro,logradouro_Parceiro,numero_Parceiro,complemento_Parceiro,bairro_Parceiro,cidade_Parceiro,uf_Parceiro,cep_Parceiro,obs_Parceiro,foto_Parceiro)
            values
            (:status_Parceiro,:nome_Parceiro,:cnpj_Parceiro,:ramo_Parceiro,:email_Parceiro,:telefone1_Parceiro,:telefone2_Parceiro,:login_Parceiro,:senha_Parceiro,:logradouro_Parceiro,:numero_Parceiro,:complemento_Parceiro,:bairro_Parceiro,:cidade_Parceiro,:uf_Parceiro,:cep_Parceiro,:obs_Parceiro,:foto_Parceiro)"
        );
